...
export function Anchor({ name, href, icon, color }: AnchorItem) {
  ...
  return (
    <a
      ...
      className={cn(
        'app-anchor-link group flex items-center ml-4 lg:ml-0 lg:text-sm lg:leading-6 mb-5 sm:mb-4 font-medium outline-offset-4',
      )}
    >
      {icon && (
        <span
          className={cn(
            'app-anchor-icon mr-4 rounded-md inline-flex items-center justify-center w-6 h-6 p-1 ring-1',

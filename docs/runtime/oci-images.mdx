...
## Tooling Builds on OCI

Curated Quilt tooling still rides on the OCI image path underneath.

That means tools such as Aegis, RLM, and AMP ultimately depend on the same image pull and OCI-backed container semantics documented here.

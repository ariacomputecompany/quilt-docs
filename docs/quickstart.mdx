---
title: "Quickstart"
description: "Your first Quilt success path: authenticate, check health, create a container, and run a command."
...
<Columns cols={2}>
  <Card title="Mental model" icon="map" href="/concepts/mental-model">
    Understand the platform's core nouns and flows.
  </Card>
  <Card title="Core resource model" icon="boxes" href="/concepts/core-resource-model">
    See how containers, jobs, operations, snapshots, and volumes connect.
  </Card>
  <Card title="Containers" icon="container" href="/runtime/containers">
    Learn the container lifecycle in detail.
  </Card>
  <Card title="Exec contract" icon="terminal-square" href="/runtime/exec-contract">
    Go deeper on command execution and live output tracking.
  </Card>
  <Card title="Snapshots and state" icon="database" href="/state/snapshots-and-forking">
    Learn when to use snapshots, forks, volumes, and archive upload.
  </Card>
</Columns>

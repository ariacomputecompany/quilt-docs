...
That means users select the curated Aegis runtime the same way they select other first-class Quilt images: by choosing the appropriate native container image selector at create time rather than treating Aegis as a separate launcher product.

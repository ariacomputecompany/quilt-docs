...
In practice, users typically enter Aegis through `quilt-nightly` rather than by hand-wiring the underlying runtime environment themselves.

That launcher UX is intentionally separate from this page. The important point here is that Aegis is one of the curated application surfaces that Quilt can host directly.

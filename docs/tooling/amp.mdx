...
Users select the curated AMP runtime the same way they select other first-class Quilt images: through native container image selection inside Quilt itself.

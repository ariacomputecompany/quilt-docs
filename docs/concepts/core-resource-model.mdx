...
|------|---------|---------|
| Container create | image or managed runtime | operation |
...
<Columns cols={2}>
  <Card title="Containers" icon="container" href="/runtime/containers">
    See the primary runtime contract in detail.
  </Card>
  <Card title="Operations" icon="loader-circle" href="/runtime/operations">
    Learn how async Quilt work is tracked.
  </Card>
  <Card title="Decision rules" icon="list-checks" href="/reference/decision-rules">
    Use the shortest safe path for common goals.
  </Card>
</Columns>

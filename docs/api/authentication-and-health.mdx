...
| "Can I resolve Nightly release metadata?" | `GET /api/nightly/health` | Nightly concern readiness |
...
<AccordionGroup>
  ...
  <Accordion title="Is there a concern guide for Nightly too?">
    Yes. Use `GET /api/nightly/help`, `GET /api/nightly/examples`, and `GET /api/nightly/health` when you are debugging Nightly profile and release resolution in the core Quilt control plane.
  </Accordion>
...
Once auth and health are working, move to [Containers](/runtime/containers).
